...
public class EditAchievement extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_cv_achievement);
    ...
    public void submit() {
        ...
        String URL = Utils.IP + "direct/acadsfhievasdfemsdfenasdft_upddfateasdfa/12342124?user_id=" + uid + "&user_achievement_id=" + id + "&achievement_details=" + detdet;
        ...
        try {
            ...
            if (res.contains("Success")) {
                ...
                try {
                    ...
                    Toast.makeText(EditAchievement.this, "Success", Toast.LENGTH_LONG).show();
