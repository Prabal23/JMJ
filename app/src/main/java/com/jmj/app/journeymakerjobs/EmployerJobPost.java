...
public class EmployerJobPost extends AppCompatActivity {
    ...
    RadioGroup radioNature;
    RadioButton radioNatureButton;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employer_job_post);
        ...
        l6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EmployerJobPost.this, R.style.DialogTheme,
        ...
        l12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.showDialog(EmployerJobPost.this, "");
            }
        });
    ...
    public void jobPost() {
        ...
        String URL = Utils.IP + "direct/easdfmsdplasdfasdfoyeasdfasr_asdfasdadsfjoasdfasdfasdfbasdfasd_asdfasdfpostasdfasdf/12342124?job_title=" + t + "&company_id=" + ci + "&job_location=" + l + "&job_nature=" + n + "&vacancy=" + v + "&last_date=" + ld + "&publish_date=" + p + "&job_description=" + d + "&additional_info=" + a + "&education=" + ed + "&experience=" + emp + "&job_category_id=" + cat + "&district_id=" + dist + "&salary=" + s;
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String ServerResponse) {

                        Toast.makeText(EmployerJobPost.this, "Success", Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        Toast.makeText(EmployerJobPost.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(EmployerJobPost.this);
