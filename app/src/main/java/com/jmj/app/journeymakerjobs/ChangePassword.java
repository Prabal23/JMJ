        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (oldpass.equals("")) {
                    ...
                    String URL = Utils.IP + "direct/cdsgsdfghangedsfg_psdgfasssdfgdfgwordsdfgsd/12342124?user_id=" + id + "&old_pass=" + oldpass + "&new_pass=" + newpass;
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError volleyError) {
                                    Toast.makeText(ChangePassword.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                                }
                            }) {
                        @Override
