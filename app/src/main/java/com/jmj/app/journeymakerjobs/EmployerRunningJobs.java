...
public class EmployerRunningJobs extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.emp_running_jobs);
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new ReadJSON().execute(Utils.IP + "direct/runasdfninasdfg_jaadsfob_lisasdft/12342124?user_id=" + id);
            }
        });
    ...
    class ReadJSON extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String content) {
            ...
            Animation animation = AnimationUtils.loadAnimation(EmployerRunningJobs.this,
                    R.anim.alpha1);
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    Intent intent = new Intent(EmployerRunningJobs.this, EmployeeJobDetails.class);
    ...
    public class CustomListAdapter extends ArrayAdapter<ProductJobPostList> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (!img.equals("") && !img.contains("localhost")) {
                Picasso.with(context).load(img).into(image);                //Picasso.with(context).load(img).into(image);
            }
            ...
            p.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(EmployerRunningJobs.this, RunningJobPicChange.class);
